...
const excludedSwaggerProperties = [
    'apis',
];
 ...
 */
const _tagDuplicated = function (target, tag) {
 ...
 */
const _attachTags = function (conf) {
    const tag = conf.tag;
 ...
 */
const _objectMerge = function (obj1, obj2) {
    const obj3 = {};
 ...
 */
const swaggerizeObj = function (swaggerObject) {
 ...
 */
const _getSwaggerSchemaWrongProperties = function () {
    return [
        'consume',
        'produce',
        'path',
 ...
 */
const _correctSwaggerKey = function (propertyName) {
 ...
 */
const _organizeSwaggerProperties = function (swaggerObject, pathObject, propertyName) {
 ...
 *                          comments
 */
const addDataToSwaggerObject = function (swaggerObject, data) {
 ...
 */
const seekWrong = function (list, wrongSet, problems) {
 ...
 */
const findDeprecated = function (sources) {
    const wrong = _getSwaggerSchemaWrongProperties();
